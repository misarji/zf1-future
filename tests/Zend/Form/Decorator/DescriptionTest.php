...
class Zend_Form_Decorator_DescriptionTest extends TestCase
{
    ...
    public function testDescriptionIsNotTranslatedTwice()
    {
        ...
        $this->markTestSkipped('Temporary skip this test because exist commit change core library make this test fail. https://github.com/misarji/zf1-future/commit/6851df2ab423eb07d3acb5a3da168b3102771513');
